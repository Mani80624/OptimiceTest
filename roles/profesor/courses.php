		...
		<section class="body">
			...
			<header class="page-header">
			  ...
			  <div class="row">
				...
				<div class="row" id="result_course">
				</div>
				<section class="panel">
				...
				<div class="row">
				 ...
				 <div class="row" id="result-register-course">
			  	...
			  	<div class="row mt-4" id="register-course">
			  		<div class="tabs">
						<div class="tab-content">
							<div class="tab">
								<div class="horizontal" id="result">
								...
								<form id="courses_form" class="form horizontal">
									...
									<div class="row">
										<div class="col-md-9 col-md-offset-3">
											...
											<button type="reset" class="btn btn-danger" id="cancel-form">Cancelar</button>
										</div>
									</div>
								</form>
							</div>
